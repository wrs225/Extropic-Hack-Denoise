#!/usr/bin/env python3
"""
Cameraman image denoising demo using MultiLayerDenoiser.
...
def main():
    # Configuration
    input_image = '/home/will/Extropic-Hack/data/cameraman.png'
    output_gif = '/home/will/Extropic-Hack/data/cameraman_denoised.gif'
    noise_level = 0.10  # 10% salt & pepper noise

    print("="*60)
    print("Cameraman Image Denoising Demo")
    print("="*60)
